...
{{businessFileSql}}
  ...
  r_create_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP NOT NULL COMMENT '本条记录的创建时间',
  r_create_by VARCHAR(25) DEFAULT '{{schemaName}}' NOT NULL COMMENT '本条记录的创建人',
  r_modify_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP NOT NULL COMMENT '本条记录的最后一次修改时间',
